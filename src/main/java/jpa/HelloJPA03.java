...
//                System.out.println(emp);
            ...
            // createQuery(질의문)
            jpql="select fname, detpid, hdate from Employees e";
...
//                  System.out.println(emp);
            ...
            // 사원이름, 직책, 부서명 조회 : join
            jpql="select e.fname,e.jobid, d.dname from Employees e join e.detpid d";
            List<Object[]> joins = em.createQuery(jpql).getResultList();
            for (Object[] join: joins)
                System.out.println(join[0] + " / " + join[1]+ " / " + join[2]);
